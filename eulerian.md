...
Or to put it another way, the number of links you *can* draw (connecting two corners each time) is $$1/2 ((n-2)(n-2) + 2(n-1)) $$ $$ = 1/2 (n^2-4n+4 + 2n-2) $$ $$ = 1/2(n^2-2n+2) $$ $$ = {1/2}n^2-n+1 $$ so the number left out is $$ {n(n-1)/2} -{1/2}n^2+n-1$$ $$ = {(n^2 - n - n^2)/2}+n-1$$ $$ = n-n/2-1 = {1/2}n-1$$
