...
# v1.3, Silas S. Brown 2019-20, public domain, no warranty
...
# Use --addpush to behave like --add but do a "git push -u origin master"
...
if test "a$Day" == a1; then
  ...
  if test "a$1" == "a--addpush"; then export Extras="-exec git push -u origin master ;"; else unset Extras; fi
